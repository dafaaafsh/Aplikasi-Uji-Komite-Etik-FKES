<x-Layout>
    ...
    <div class="mx-3 mt-1 p-3 bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('penguji.profil.update') }}" method="POST" class="space-y-6">
          @csrf
  ...
  <div id="modalAvatar" class="fixed inset-0 bg-black/50 z-50 hidden flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-sm p-6">
      ...
      <form action="{{ route('penguji.profil.uploadAvatar') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        <input 
          type="file" 
          name="avatar" 
