        ...
        <div class="border-b pb-4 border-gray-500">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="email" value="{{ $user->email }}" readonly class="mt-1 block w-full text-gray-400 bg-gray-50 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" />
            </div>
            <div>
...
<div id="modalAvatar" class="fixed inset-0 bg-black/50 z-50 hidden flex items-center justify-center">
  <div class="bg-white rounded-lg shadow-lg w-full max-w-sm p-6">
    ...
    <form action="{{ route('peneliti.profil.uploadAvatar') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
      @csrf
      <input 
        type="file" 
        name="avatar" 
